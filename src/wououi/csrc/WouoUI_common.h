...
// Bare-metal: use minimal type definitions
#include "wououi_types.h"

// Minimal string/memory functions - implemented in WouoUI_port.c
extern int wououi_strlen(const char* s);
extern char* wououi_strcpy(char* dst, const char* src);
extern char* wououi_strchr(const char* s, int c);
extern int wououi_strcmp(const char* s1, const char* s2);
extern void* wououi_memset(void* s, int c, size_t n);
extern void* wououi_memcpy(void* dst, const void* src, size_t n);
extern int wououi_sprintf(char* str, const char* format, ...);

#define strlen  wououi_strlen
#define strcpy  wououi_strcpy
#define strchr  wououi_strchr
#define strcmp  wououi_strcmp
#define memset  wououi_memset
#define memcpy  wououi_memcpy
#define sprintf wououi_sprintf

#else
// Standard environment: use standard headers
